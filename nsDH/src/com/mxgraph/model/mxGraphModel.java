/**
 * $Id: mxGraphModel.java,v 1.71 2009/09/12 06:16:54 gaudenz Exp $
	...
	public void updateEdgeParent(Object edge, Object root)
	{
			...
			isAncestor(root, target))
		{
				...
				getParent(edge) != cell)
			{
				...
				System.out.println("Moving edge "+((mxICell) edge).getValue()+" to parent "+mxCellPath.create((mxICell) cell));
