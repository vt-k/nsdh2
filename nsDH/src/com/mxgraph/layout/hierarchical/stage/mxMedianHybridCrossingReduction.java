		...
		mxHierarchicalLayoutStage/*, JGraphLayout.Stoppable*/
{
	...
	public void execute(Object parent)
	{
		...
		{
			mxGraphHierarchyRank rank = (mxGraphHierarchyRank) model.ranks
					.get(new Integer(i));
		...
		Collection[] rankList = new mxGraphHierarchyRank[model.maxRank + 1];
	...
	protected int calculateRankCrossing(int i, mxGraphHierarchyModel model)
	{
		...
		mxGraphHierarchyRank rank = (mxGraphHierarchyRank) model.ranks
				.get(new Integer(i));
		mxGraphHierarchyRank previousRank = (mxGraphHierarchyRank) model.ranks
				.get(new Integer(i - 1));
		...
		while (iter.hasNext())
		{
			...
			while (iter2.hasNext())
			{
				mxGraphAbstractHierarchyCell connectedCell = (mxGraphAbstractHierarchyCell) iter2
						.next();
