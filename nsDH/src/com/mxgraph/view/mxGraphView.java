/**
 * $Id: mxGraphView.java,v 1.130 2009/10/19 10:39:20 gaudenz Exp $
...
public class mxGraphView extends mxEventSource
{
			...
			Object target)
	{
		if (state != null)
		{
			...
			mxEdgeStyleFunction edgeStyle = getEdgeStyle(state, points, source, target);
	 ...
	 */
	public mxEdgeStyleFunction getEdgeStyle(mxCellState edgeState, List points,
