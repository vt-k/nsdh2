/**
 * $Id: mxGraph.java,v 1.240 2009/09/12 06:16:54 gaudenz Exp $
...
public class mxGraph extends mxEventSource
{
	 ...
	 * Updates the size of the given cell in the model using
	 * getPreferredSizeForCell to get the new size. This function
	 * fires mxEvent.UPDATE_CELL_SIZE events.
	 * 
	 ...
	 * Fires a repaint event.
	 */
	public void repaint(mxRectangle dirty)
	{
		mxEventObject evt = new mxEventObject(new Object[] { dirty });
	...
	public void setCellsResizable(boolean value)
	{
		...
		changeSupport
				.firePropertyChange("cellsResizable", oldValue, cellsResizable);
	}
