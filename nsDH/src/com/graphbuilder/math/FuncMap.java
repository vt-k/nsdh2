	...
	*/
	public void loadDefaultFunctions() {
		...
		setFunction("log", new LogFunction());
                ...
                // 4 parameters
               setFunction("if_less", new If_lessFunction());
               setFunction("if_less_equal", new If_less_equalFunction());
               setFunction("if_greater", new If_greaterFunction());
               setFunction("if_greater_equal", new If_greater_equalFunction());
